...
const seedData = async () => {
  ...
  try {
    ...
    const captains = [
      ...
      { name: "Kenny", team: "Khajoor Knights", budget: 1000, initialBudget: 1000, players: [] },
    ];
    ...
    const players = [
      ...
      { name: "Hasan Motiwala", age: 34, position: "Forward", priorTeam: "23Sb", availability: "75% availability", contact: "6'0" },
      ...
      { name: "Ahad", age: 23, position: "Guard", priorTeam: "Omega", availability: "Available through out", contact: "5'11" },
      { name: "Muhammad Aslam Aman", age: 18, position: "Guard", priorTeam: "OTHER", availability: "75% availability", contact: "5'8" },
      { name: "Umer", age: 23, position: "Forward", priorTeam: "OTHER", availability: "Available through out", contact: "6ft" },
      ...
      { name: "Ali Kazmi", age: 25, position: "Forward", priorTeam: "OTHER", availability: "Available through out", contact: "6'3" },
      { name: "Aijaz Ali", age: 21, position: "Forward", priorTeam: "Maverick", availability: "50% availability", contact: "6'1" },
      { name: "Maaz Kashif", age: 19, position: "Forward", priorTeam: "OTHER", availability: "Available through out", contact: "5'11" },
      ...
      { name: "Safwan Shabu", age: 22, position: "Guard", priorTeam: "Bounce", availability: "Available through out", contact: "5'9" },
      { name: "SchWiFTY", age: 25, position: "Guard", priorTeam: "Mamba", availability: "Available through out", contact: "5'11" },
      ...
      { name: "BABBAN", age: 24, position: "Center", priorTeam: "Omega", availability: "Available through out", contact: "6.1" },
      ...
      { name: "Abdullah Javed", age: 18, position: "Forward", priorTeam: "Dukes", availability: "50% availability", contact: "6ft" },
      ...
      { name: "Sherjeel Sethi", age: 25, position: "Center", priorTeam: "Saber", availability: "75% availability", contact: "6'3" },
      ...
      { name: "Abeer Jawad aka Bhaloo", age: 18, position: "Forward", priorTeam: "Void", availability: "Available through out", contact: "6ft" },
      ...
      { name: "Tabby", age: 35, position: "Forward", priorTeam: "Saber", availability: "Unknown", contact: "-" },
      { name: "Ahaidh", age: 35, position: "Center", priorTeam: "Other", availability: "Unknown", contact: "-" },
      { name: "Moiz Bazai", age: 20, position: "Forward", priorTeam: "Raider", availability: "Unknown", contact: "-" },
      { name: "Ali Akbar", age: 35, position: "Forward", priorTeam: "Other", availability: "Unknown", contact: "-" },
      { name: "Raamish", age: 30, position: "Guard", priorTeam: "Mamba", availability: "100% availability", contact: "5'10" },
      { name: "Umer Khawaja", age: 27, position: "Center", priorTeam: "23Sb", availability: "100% availability", contact: "-" },
